...
public class Shooter : MonoBehaviour
{
    ...
    public void Shoot()
    {
        ...
        //Rotationが扱っているQuaternion型として準備（ｑ）
        ...
        float x = Mathf.Cos(angleZ * Mathf.Deg2Rad); //角度に対する底辺Ｘ軸の方向
        float y = Mathf.Sin(angleZ * Mathf.Deg2Rad); //角度に対する高さＹ軸の方向
        //角度を分解したxとyをもとに方向データとして整理
        Vector2 v = new Vector2(x,y).normalized * shootSpeed;

        //AddForceで指定した方角にお札を飛ばす
